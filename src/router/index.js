...
export const constantRouterMap = [
    ...
    children: [
      {
        path: 'index',
        name: 'index',
        component: () => import('@/views/musicPage/musicmange'),
        meta: { title: '歌曲管理', icon: 'discounting' }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'index',
        name: 'index',
        component: () => import('@/views/musicPage/user'),
  ...
  //       name: 'administrativeenforcement',
  //       component: () => import('@/views/electronic/administrativeenforcement'),
  //       meta: { title: 'administrativeenforcement' }
  //     },
  //     {
  //       path: 'speedalarm',
  //       name: 'speedalarm',
  //       component: () => import('@/views/electronic/speedalarm'),
  //       meta: { title: 'speedalarm' }
  //     },
  //     {
  //       path: 'beidouPositioning',
  //       name: 'beidouPositioning',
  //       component: () => import('@/views/electronic/beidouPositioning'),
  //       meta: { title: 'beidouPositioning' }
  //     },
  //     {
  //       path: 'positioninformation',
  //       name: 'positioninformation',
  //       component: () => import('@/views/electronic/positioninformation'),
  //       meta: { title: 'positioninformation' }
  //     },
  //     {
  //       path: 'operationrecord',
  //       name: 'operationrecord',
  //       component: () => import('@/views/electronic/operationrecord'),
  //       meta: { title: 'operationrecord' }
  //     },
  //     {
  //       path: 'vehicleinformation',
  //       name: 'vehicleinformation',
  //       component: () => import('@/views/electronic/vehicleinformation'),
  //       meta: { title: 'vehicleinformation' }
  //     },
  //     // {
  //     //   path: 'complex-table',
  //     //   name: 'complex-table',
  ...
  //       component: () => import('@/views/electronic/checkworkattendance'),
  //       meta: { title: 'checkworkattendance' }
  //     },
  //     {
  //       path: 'qualityservice',
  //       name: 'qualityservice',
  //       component: () => import('@/views/electronic/qualityservice'),
  //       meta: { title: '服务质量' }
  //     },
  //     {
  //       path: 'cardpayment',
  //       name: 'cardpayment',
  //       component: () => import('@/views/electronic/cardpayment'),
  //       meta: { title: 'cardpayment' }
  //     },
  //     {
  //       path: 'alarmmanagement',
  //       name: 'alarmmanagement',
  //       component: () => import('@/views/electronic/alarmmanagement'),
  //       meta: { title: '告警管理' }
  //     },
  //     {
  //       path: 'terminalmanagement',
  //       name: 'terminalmanagement',
  //       component: () => import('@/views/electronic/terminalmanagement'),
  //       meta: { title: '终端管理' }
  //     },
